...
class StartTrueFalseGameMobilePortrait extends StatelessWidget {
            ...
            children: [
              ...
              Expanded(
                child: CustomButton(
                  ...
                  buttonText: 'False',
                  onPressed: () {
                    showSuccessOrFailureDialog(context, isCorrect: false);
                  },
                ),
              )
            ],
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  '${controller.currentPage.value + 1}/${controller.items.length}',
  ...
  void showSuccessOrFailureDialog(BuildContext context, {isCorrect = true}) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
