...
class DashboardHeroSessionUI extends StatelessWidget {
  const DashboardHeroSessionUI({
    Key? key,
  }) : super(key: key);
    ...
    return FadeIn(
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            Image.asset(
              'assets/svgs/home_dashboard_card.png',
              // color: Colors.grey.shade200,
            ),
            Image.asset(
              'assets/svgs/home_dashboard_frame.png',
              // color: Colors.grey.shade200,
            ),
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 16.0),
